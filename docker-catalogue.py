...
init_environments = [
  ...
  k8s.V1EnvVar(name='MG_CATALOGUE_USERNAME_STAGING', value=dag_run.staging_username),
  k8s.V1EnvVar(name='MG_CATALOGUE_PASSWORD_STAGING', value=dag_run.staging_password),
  k8s.V1EnvVar(name='MG_CATALOGUE_URL_PROD', value='https://emx2.test.molgenis.org/'),
  k8s.V1EnvVar(name='MG_CATALOGUE_USERNAME_PROD', value=dag_run.prod_username),
  k8s.V1EnvVar(name='MG_CATALOGUE_PASSWORD_PROD', value=dag_run.prod_password)
]
